        ...
        <>
          <div>
            <div className="flex flex-row items-end mb-20" data-aos="fade-up">
              ...
              >
                ...
                <div className="flex flex-col items-end">
                  <div className="mx-72 bg-black bg-opacity-70 p-12">
            ...
            <div className="flex flex-row justify-between my-20">
              <div
                className="bg-cover text-white p-8 w-7/12 rounded-br-full shadow-sm"
                style={{
                  backgroundImage: `url('https://c4.wallpaperflare.com/wallpaper/744/804/845/computer-engineering-science-tech-wallpaper-preview.jpg')`,
                }}
              ...
              >
                ...
                <div className="flex flex-col items-end">
                  <div className="mx-16 bg-black bg-opacity-70 w-10/12 p-4">
                    <p className="leading-8">
              ...
              <img
                className="mx-16 my-8 w-5/12 max-h-96"
            ...
            <div className="flex flex-row items-end my-20">
              ...
              />
              <div
                className="bg-cover text-white p-8 w-7/12 rounded-bl-full shadow-sm"
                style={{
                  backgroundImage: `url('https://c4.wallpaperflare.com/wallpaper/744/804/845/computer-engineering-science-tech-wallpaper-preview.jpg')`,
                }}
                data-aos="fade-up-left"
              >
                ...
                <div className="flex flex-col items-end">
                  <div className="mx-16 bg-black bg-opacity-70 w-9/12 p-4">
                    <p className="leading-8">
